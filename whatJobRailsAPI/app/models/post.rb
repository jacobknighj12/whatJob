...
validates_format_of :work_life_balance, :title, :intro, :day_to_day, :job_security, :industry_growth, :work_life_balance, :role_details, :job_description, with: /[A-Za-z0-9 _\-.,;#&!?"'\\/$()%]*/
